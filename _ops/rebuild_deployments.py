...
INTERNAL_SCRIPT_PATH = "/app/_ops/rebuild_deployments.py"
...
if not IN_DOCKER:
    ...
    try:
        ...
        cmd = ["docker", "exec", "-t", container_id, "python", "/app/_ops/rebuild_deployments.py"]
...
HASH_STORAGE = "/app/_ops/.deployments_hashes.json"
